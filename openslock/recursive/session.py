...
class RecursiveSession:
    ...
    async def turn(self, user_msg: str, *, force_cloud: bool = False,
        ...
        # --- (1) topic gate ---
        switched = False
        if self.trained_once and not force_cloud:
    ...
    async def _resolve_topic(self, user_msg: str, is_switch: bool) -> str:
        ...
        if self.persist:
            ...
            if hit is not None:
                ...
                try:
                    ...
                    # Use local MAS to answer this turn since links are loaded.
                    return await self._first_turn_after_resolve(user_msg)

        # Fall through: bootstrap + train.
        return await self._bootstrap_and_train(user_msg, is_switch)

    async def _first_turn_after_resolve(self, user_msg: str) -> str:
